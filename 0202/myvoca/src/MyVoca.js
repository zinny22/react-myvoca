...
import { loadVocaFB, deleteVocaFB} from "./redux/modules/voca";
                ...
                return(
                    <Cards key={index}>
                        ...
                        <div style={{color :"#7c43bd",}}>
                            <span style={{margin:"5px"}}>{checkicon}</span>
                            <span style={{margin:"5px"}} onClick={()=>{navigate(`/detail/${voca.id}`)}}>{editicon}</span>
                            <span style={{margin:"5px"}} onClick={()=>{dispatch(deleteVocaFB(voca.id))}}>{transhicon}</span>
                        </div>
